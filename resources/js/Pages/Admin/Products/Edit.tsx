...
export default function ProductEdit({ product, brands }: ProductEditProps) {
    ...
    const preview = objectUrl ?? product.image;
    ...
    function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        post(`/admin/products/${product.id}`, {
            ...
            onError: () => toast.error('Failed to update product. Please check the form.'),
        });
    }

    return (
        <AdminLayout breadcrumbs={[{ label: 'Products', href: '/admin/products' }, { label: 'Edit' }]}>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0 space-y-1.5">
                                ...
                                <Button type="button" variant="outline" size="sm" onClick={() => inputRef.current?.click()}>
                                    ...
                                    {data.image ? 'Change image' : 'Upload new image'}
                                </Button>
                                <p className="truncate text-xs text-muted-foreground">
                                    {data.image ? data.image.name : 'Leave empty to keep the current image'}
                                </p>
                            </div>
                        </div>
