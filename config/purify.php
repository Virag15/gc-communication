    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1[style],h2[style],h3[style],h4,h5,h6,b,u,strong,i,em,s,del,a[href|title|target|rel],ul,ol,li,p[style],br,span[style],pre,code,blockquote,hr,img[src|alt|width|height]',
            'HTML.ForbiddenElements' => 'script,style,iframe,object,embed,form,input,textarea,select,button',
            'CSS.AllowedProperties' => 'text-align,text-decoration,font-weight,font-style',
